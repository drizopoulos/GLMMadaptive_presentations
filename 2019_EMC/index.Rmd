...
${\color{red} \Rightarrow}$ <font color = "red">Less options available in most software</font>
</div>
...
- adaptive Gassian quadrature: Gold standard
...
- **lme4**
    ...
    + adaptive Gaussian quadrature only for scalar radnom effects
...
## Available Models: Specialized GLMMs - 3
...
- Hurdle mixed models
    ...
    + hudle log-normal `family = hurdle.lognormal()`
...
- 8 vignettes describing in detail and with examples the above & more
